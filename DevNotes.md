...
```json
{
  "tutorialId": "my_custom_tutorial_v1",
  "title": "My Custom Tutorial (Test Data)",
  "description": "Tutorial JSON for the Fusion tutorial player.",
  "steps": [
    {
      "stepId": "step-1",
      "stepNumber": 1,
      ...
      "detailedText": "More detailed guidance for this step.",
      "expandedContent": {
        "whyThisMatters": "Why this step matters for model quality and workflow stability."
      },
      "tips": [
        "Short tip 1",
        "Short tip 2"
      ...
      "qcChecks": [
        {
          "text": "QC item text shown to the learner",
          "expectedCommand": "FusionCommandId"
        }
      ],
      "fusionActions": [
        { "type": "ui.openPanel", "panel": "browser" },
        { "type": "ui.openWorkspace", "workspace": "Design", "environment": "Solid" },
        { "type": "ui.enterMode", "mode": "Sketch" },
        { "type": "ui.hint", "text": "Hint shown to user" }
      ],
      "visualStep": {
        "images": [
          {
            "image": "assets/UI Images/Solid/Solid_0.png",
            "caption": "Reference UI state",
            "highlights": [
              {
                "component": "toolbar.create.revolve",
                "label": "Revolve"
              }
            ]
          }
...
- `qcChecks[].expectedCommand` should map to the Fusion command expected for step completion tracking.
- Use `visualStep.images` when you want annotated UI references in the palette.
